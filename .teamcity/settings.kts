...
object Build : BuildType({
    ...
    params {
        ...
        text("Confirmation", "%reverse.dep.BuildAll.env.CONFIRMATION%", description = "WARNING: This will upload the installers to the web site. Please review the Dependencies tab for what versions will be published.", display = ParameterDisplay.PROMPT,
