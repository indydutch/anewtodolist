...
object Build : BuildType({
    ...
    params {
        ...
        checkbox("DryRun", "%env.DRYRUN%", description = "If enabled, does not perform any publish, only reports the actions it would take.", display = ParameterDisplay.PROMPT,
                  checked = "-d")
        ...
        text("Confirmation", "%env.CONFIRMATION%", description = "WARNING: This will upload the installers to the web site. Please review the Dependencies tab for what versions will be published.", display = ParameterDisplay.PROMPT,
